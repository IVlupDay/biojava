...
public class SequenceComparer {
	...
	private boolean mismatchingDone = false; 
	
	enum lut {AA('A'), AC('M'), AG('R'), AT('W'), AR('R'), AY('H'), AK('D'), AM('M'), AS('V'), AW('W'), AB('N'), AD('D'), AH('H'), AV('V'), AN('N'),
	...
	public static void main(String[] args) {
		SequenceComparer sc = new SequenceComparer(new DNASequence("CC"), new DNASequence("GG", AmbiguityDNACompoundSet.getDNACompoundSet()));
		System.out.println(sc.getDifferenceCount());
		System.out.println(sc.getConsensusSequence());
		sc = new SequenceComparer(new DNASequence("AA"), new DNASequence("CC", AmbiguityDNACompoundSet.getDNACompoundSet()));
		System.out.println(sc.getDifferenceCount());
		System.out.println(sc.getConsensusSequence());
